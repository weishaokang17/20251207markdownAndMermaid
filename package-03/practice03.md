...
- If it is mentioned in the issues and you want to fix it, [fork](https://github.com/TheAlgorithms/Java/issues) the repository and submit your implementation in a pull request. The project maintainers will evaluate it.
- If the bug is **NOT** mentioned in the issues, [open a new issue](https://github.com/TheAlgorithms/Java/issues). Be sure to include a **title**, a clear **description** and a **test case** demonstrating the expected behavior that is not occurring.
...
+ [Fork](https://github.com/TheAlgorithms/Java/issues) the repository and make necessary changes.
+ Create a pull request.
+ It will be put under review for approval.
+ If approved, the requested changes will be merged to the repository.

### Do you want to add a new feature?
+ [Open a new issue.](https://github.com/TheAlgorithms/Java/issues)
...
+ Ask any question about how to use the repository in the [TheAlgorithms room in GITTER](https://github.com/TheAlgorithms/Java/issues) or [open a new issue](https://github.com/TheAlgorithms/Java/issues).  
